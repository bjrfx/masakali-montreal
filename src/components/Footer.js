          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <div className="space-y-2">
                ...
                <a href="mailto:masakalimontreal@gmail.com" className="text-neutral-500 dark:text-neutral-400 text-sm hover:text-neutral-900 dark:hover:text-white transition-colors flex items-center gap-2">
                  <Mail size={14} /> masakalimontreal@gmail.com
                </a>
              </div>
            </div>
          </div>
